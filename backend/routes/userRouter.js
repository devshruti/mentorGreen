...
userRouter.post('/login', async (req, res) => {
    try {
        ...
        if (result) {
            ...
            const uid = user._id;
            res.cookie('access_token', accessToken, { maxAge: 900000, httpOnly: true, secure: true });
            res.cookie('refresh_token', refreshToken, { maxAge: 30 * 24 * 60 * 60 * 1000, httpOnly: true, secure: true });
            console.log("login")
